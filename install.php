<?php
	if(isset($_POST["install"])) {
		...
		$sqls0 = array("CREATE DATABASE SimpleCryptoShop", "CREATE TABLE `SimpleCryptoShop`.`Items` ( `id` INT(255) NOT NULL AUTO_INCREMENT , `img` TEXT NOT NULL , `name` VARCHAR(50) NOT NULL , `dscr` VARCHAR(100) NOT NULL , `content` TEXT NOT NULL , `price` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;", "CREATE TABLE `simplecryptoshop`.`btc_tx` ( `id` INT(255) NOT NULL AUTO_INCREMENT , `tx` VARCHAR(64) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;", "CREATE TABLE `simplecryptoshop`.`eth_tx` ( `id` INT(255) NOT NULL AUTO_INCREMENT , `tx` VARCHAR(64) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;", "CREATE TABLE `simplecryptoshop`.`ltc_tx` ( `id` INT(255) NOT NULL AUTO_INCREMENT , `tx` VARCHAR(64) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;", "CREATE TABLE `simplecryptoshop`.`xmr_tx` ( `id` INT(255) NOT NULL AUTO_INCREMENT , `tx` VARCHAR(64) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;", "CREATE TABLE `simplecryptoshop`.`dash_tx` ( `id` INT(255) NOT NULL AUTO_INCREMENT , `tx` VARCHAR(64) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");
